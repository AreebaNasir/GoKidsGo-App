...
public class B extends AppCompatActivity {
    ...
    ImageView farrow,prev;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b);
        back=findViewById(R.id.back);
        farrow = findViewById(R.id.farrow1);
        ...
        farrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i1 = new Intent(B.this,C.class);
                startActivity(i1);
                finish();
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(B.this,A.class);
                startActivity(i2);
                finish();
                overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
            }
    ...
    private void speak()
    {
        String txt1=bear.getText().toString();
