...
public class One extends AppCompatActivity {
    ...
    FloatingActionButton back,set,music,audio;
    TextView one,onet,sen;
    ImageView pooh,apple,cloud,barrow,farrow;
    int musicc = 1;
    ...
    private void speak()
    {
        String txt=onet.getText().toString();
